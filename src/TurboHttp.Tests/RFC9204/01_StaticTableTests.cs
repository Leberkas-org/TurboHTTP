...
/// </summary>
public sealed class QpackStaticTableTests
{
    /// RFC 9204 Appendix A — Static table contains exactly 99 entries
    [Fact(DisplayName = "RFC9204-A-ST-001: Static table contains exactly 99 entries")]
    ...
    [Fact(DisplayName = "RFC9204-A-ST-002: Index 0 is :authority with empty value")]
    ...
    [Fact(DisplayName = "RFC9204-A-ST-003: Index 98 is x-frame-options sameorigin")]
    ...
    [Theory(DisplayName = "RFC9204-A-ST-004: All 99 static entries have correct name and value")]
    ...
    [Theory(DisplayName = "RFC9204-3.1-ST-005: FindExact returns correct index for known pairs")]
    ...
    [Theory(DisplayName = "RFC9204-3.1-ST-006: FindExact returns -1 for unknown pairs")]
    ...
    [Theory(DisplayName = "RFC9204-3.1-ST-007: FindName returns lowest index for known names")]
    [InlineData(":authority", 0)]
    [InlineData(":path", 1)]
    ...
    [Theory(DisplayName = "RFC9204-3.1-ST-008: FindName returns -1 for unknown names")]
    [InlineData("x-custom")]
    [InlineData("host")]
    ...
    [Fact(DisplayName = "RFC9204-A-ST-009: Pseudo-headers at expected indices")]
    ...
    [Fact(DisplayName = "RFC9204-A-ST-010: All entries with values have exact match in lookup")]
    ...
    [Fact(DisplayName = "RFC9204-A-ST-011: All entries have name match in lookup")]
