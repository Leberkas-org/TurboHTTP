...
public sealed class CookieSecurityTests
{
    ...
    [Fact(DisplayName = "SEC-COOKIE-001: Secure cookie NOT sent over HTTP — credential leakage prevention")]
    public void Should_NotSendSecureCookie_When_RequestIsHttp()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-002: Secure cookie sent over HTTPS — legitimate transport")]
    public void Should_SendSecureCookie_When_RequestIsHttps()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-003: Non-Secure cookie sent over both HTTP and HTTPS")]
    public void Should_SendNonSecureCookie_When_AnyScheme()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-004: HttpOnly flag stored correctly — informational (server-enforced)")]
    public void Should_StoreHttpOnlyFlag_When_SetCookieContainsHttpOnly()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-005: SameSite=Strict stored — cross-site CSRF mitigation")]
    public void Should_StoreSameSiteStrict_When_SetCookieContainsStrict()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-006: SameSite=Lax stored — safe top-level navigation allowed")]
    public void Should_StoreSameSiteLax_When_SetCookieContainsLax()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-007: SameSite=None stored — requires Secure for cross-site use")]
    public void Should_StoreSameSiteNone_When_SetCookieContainsNone()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-008: Subdomain cookie not sent to parent domain — scope escalation")]
    public void Should_NotSendSubdomainCookie_When_RequestToParentDomain()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-009: Domain cookie sent to subdomains but not unrelated domains")]
    public void Should_SendDomainCookieToSubdomain_When_DomainAttributeSet()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-010: Label boundary enforced — notexample.com ≠ example.com")]
    public void Should_NotMatchCookie_When_DomainIsSubstringButNotLabelBoundary()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-011: IP address rejects domain cookie — no subdomain matching")]
    public void Should_RejectDomainMatch_When_RequestHostIsIpAddress()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-012: Host-only cookie requires exact domain match")]
    public void Should_NotSendHostOnlyCookie_When_RequestToSubdomain()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-013: Reject cookie from unrelated domain — domain takeover prevention")]
    public void Should_RejectCookie_When_DomainAttributeDoesNotMatchRequestHost()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-014: /foo cookie not sent to /bar — path scope isolation")]
    public void Should_NotSendCookie_When_RequestPathOutsideCookiePath()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-015: /foo cookie sent to /foo/sub — path prefix match")]
    public void Should_SendCookie_When_RequestPathIsSubpathOfCookiePath()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-016: /foo cookie not sent to /foobar — path label boundary required")]
    public void Should_NotSendCookie_When_RequestPathSharesPrefixButNotBoundary()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-017: Path traversal /foo/.. does not match / — traversal attack")]
    public void Should_NotMatchRoot_When_PathContainsTraversal()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-018: Path traversal /bar/../foo normalized by Uri to /foo — safe by URI layer")]
    public void Should_MatchFooCookie_When_UriNormalizesTraversalToFoo()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-019: Max-Age=0 immediately deletes existing cookie")]
    ...
    [Fact(DisplayName = "SEC-COOKIE-020: Max-Age=0 prevents cookie from being added")]
    public void Should_NotStoreCookie_When_MaxAgeIsZero()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-021: Negative Max-Age treated as expired — deletion semantics")]
    public void Should_NotStoreCookie_When_MaxAgeIsNegative()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-022: Overlong cookie value handled without crash or OOM")]
    public void Should_HandleGracefully_When_CookieValueIsExtremelyLarge()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-023: Overlong cookie name handled without crash")]
    public void Should_HandleGracefully_When_CookieNameIsExtremelyLarge()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-024: Many cookies handled without crash — cookie bomb attack")]
    public void Should_HandleGracefully_When_ManyCookiesStored()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-025: Secure + HttpOnly + SameSite=Strict stored together")]
    public void Should_StoreAllSecurityAttributes_When_CombinedOnSingleCookie()
    {
    ...
    [Fact(DisplayName = "SEC-COOKIE-026: Domain + Path combined scoping enforced")]
    public void Should_EnforceCombinedScoping_When_DomainAndPathBothSet()
    {
