...
{
    private static byte[] Encode(string s) => HuffmanCodec.Encode(Encoding.UTF8.GetBytes(s));
    private static string Decode(byte[] b) => Encoding.UTF8.GetString(HuffmanCodec.Decode(b));
    ...
    public void HuffmanCodec_should_detect_eos_padding_misuse()
    {
        ...
        var ex = Assert.Throws<HpackException>(
            () => HuffmanCodec.Decode(invalidData));
    ...
    public void HuffmanCodec_should_validate_padding_bits()
    {
        ...
        var result = HuffmanCodec.Decode(data);
    ...
    public void HuffmanCodec_should_encode_all_byte_values(byte value)
    {
        ...
        var encoded = HuffmanCodec.Encode(data);
        var result = HuffmanCodec.Decode(encoded);
    ...
    public void HuffmanCodec_should_reject_truncated_input()
    {
        ...
        var ex = Assert.Throws<HpackException>(
            () => HuffmanCodec.Decode(incompleteData));
