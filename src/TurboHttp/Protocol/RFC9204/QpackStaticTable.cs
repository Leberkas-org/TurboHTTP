...
public static class QpackStaticTable
{
    ...
    /// </summary>
    private static readonly FrozenDictionary<(string Name, string Value), int> _exactIndex =
        BuildExactIndex();
    ...
    /// </summary>
    private static readonly FrozenDictionary<string, int> _nameIndex =
        BuildNameIndex();
    ...
    {
        return _exactIndex.TryGetValue((name, value), out var index) ? index : -1;
    }
    ...
    {
        return _nameIndex.TryGetValue(name, out var index) ? index : -1;
    }
