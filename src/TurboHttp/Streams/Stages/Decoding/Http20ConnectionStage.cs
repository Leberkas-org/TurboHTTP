...
public sealed class Http20ConnectionStage : GraphStage<Http20ConnectionShape>
{
    ...
    {
        private const int StatePoolCapacity = 32;
        ...
        private readonly Stack<StreamState> _statePool = new(StatePoolCapacity);
        ...
        public Logic(Http20ConnectionStage stage) : base(stage.Shape)
        {
            ...
            const int MaxWindowUpdateThreshold = 32_768;
        ...
        {
            state.Reset();
            if (_statePool.Count < StatePoolCapacity)
            {
