...
public sealed class Http2EncoderPseudoHeaderSpec
{
    ...
    public void Http2RequestEncoder_should_pass_validation_when_all_required_pseudo_headers_present(string path, string method, string scheme, string authority, int regularHeaderCount)
    {
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_throw_http2_exception_when_single_required_pseudo_header_missing(string missingHeader)
    {
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_list_all_missing_headers_when_multiple_pseudo_headers_missing(bool includeMethod, string expectedMissingCsv)
    {
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_throw_http2_exception_when_duplicate_pseudo_header_detected(string pseudoHeader, string duplicateValue)
    {
        var headers = AllFourPseudos("/", "GET", "https", "example.com");
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_throw_http2_exception_when_unknown_pseudo_header_detected(string unknownHeader, string value)
    {
        var headers = AllFourPseudos("/", "GET", "https", "example.com");
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_throw_http2_exception_when_pseudo_header_appears_after_regular_header(int insertIndex, string regularName, string regularValue)
    {
        var headers = AllFourPseudos("/", "GET", "https", "example.com");
    ...
    public void Http2RequestEncoder_should_include_indices_in_message_when_pseudo_after_regular_header_violation()
    {
        var headers = new List<HpackHeader>
        {
            ...
            new(":path", "/"),           // pseudo at index 2 — INVALID
            new(":scheme", "https"),
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_match_expected_value_when_pseudo_header_encoded(string method, string url, string expectedHeader, string expectedValue)
    {
    ...
    [Trait("RFC", "RFC9113-8.1.2.1")]
    public void Http2RequestEncoder_should_have_all_four_pseudo_headers_present_when_encoding(string method, string url, bool useHuffman, bool includeBody)
    {
        var request = new HttpRequestMessage(new HttpMethod(method), url);
        if (includeBody)
        {
