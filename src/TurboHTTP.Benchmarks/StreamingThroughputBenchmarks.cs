...
public class StreamingThroughputBenchmarks
{
    ...
    private void SetupTurboClient()
    {
        ...
        var options = new TurboClientOptions
        {
            ...
            Http1 = new Http1Options { MaxConnectionsPerServer = 1 },
            Http2 = new Http2Options { MaxConnectionsPerServer = 512 }
        };

        _turboSystem = ActorSystem.Create($"turbohttp-streaming-{Guid.NewGuid():N}");
