    ...
    private sealed class Logic : GraphStageLogic
    {
        ...
        public Logic(Http20EncoderStage stage) : base(stage.Shape)
        {
            ...
            SetHandler(stage._out, () =>
            {
                ...
                {
                    _prefaceSent = true;
                    var (prefaceOwner, prefaceLength) = BuildHttp2ConnectionPreface(_stage._initialWindowSize);
        ...
        private static (IMemoryOwner<byte> Owner, int Length) BuildHttp2ConnectionPreface(int windowSize)
        {
