...
public sealed class Http3StageCompletionRegressionSpec : StreamTestBase
{
    ...
    {
        // Provide a minimal valid HEADERS frame (:status 200) then fail.
        // QPACK: 0x00=Required Insert Count, 0x00=Delta Base, 0xD9=static indexed field line index 25 (:status 200)
        var headersFrame = new Http3HeadersFrame(new byte[] { 0x00, 0x00, 0xD9 });
