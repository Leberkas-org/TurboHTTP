...
public sealed class ExpectContinueIntegrationTests
{
    ...
    [Fact(DisplayName = "Expect-TLS-001: Small body sent without Expect header returns 200 echo over HTTPS")]
    ...
    [Fact(DisplayName = "Expect-TLS-002: Large body triggers 100-continue flow and returns 200 echo over HTTPS")]
    ...
    [Fact(DisplayName = "Expect-TLS-003: Server rejection returns 417 Expectation Failed over HTTPS")]
