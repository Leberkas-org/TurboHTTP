...
public sealed class CompressionIntegrationTests
{
    ...
    public CompressionIntegrationTests(KestrelFixture fixture, ActorSystemFixture systemFixture)
    {
        _fixture = fixture;
    ...
    [Fact(DisplayName = "Compression-001: gzip response transparently decompressed to original size")]
    ...
    [Fact(DisplayName = "Compression-002: deflate response transparently decompressed")]
    ...
    [Fact(DisplayName = "Compression-003: brotli response transparently decompressed")]
    ...
    [Fact(DisplayName = "Compression-004: identity encoding passes through unchanged")]
    ...
    [Fact(DisplayName = "Compression-005: content negotiation with Accept-Encoding gzip returns gzip response")]
    ...
    [Fact(DisplayName = "Compression-006: content negotiation with Accept-Encoding br returns brotli response")]
    ...
    [Fact(DisplayName = "Compression-007: content negotiation with no Accept-Encoding returns identity")]
