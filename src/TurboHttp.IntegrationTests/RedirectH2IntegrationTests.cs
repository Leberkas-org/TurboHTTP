...
public sealed class RedirectH2IntegrationTests
{
    private readonly KestrelH2Fixture _fixture;

    public RedirectH2IntegrationTests(KestrelH2Fixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact(DisplayName = "Redirect-H2-001: GET 301 redirect follows to /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-002: GET 302 redirect follows to /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-003: GET 307 redirect follows to /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-004: GET 308 redirect follows to /hello")]
    ...
    [Theory(DisplayName = "Redirect-H2-005: Redirect chain of N hops ends at /hello")]
    [InlineData(1)]
    [InlineData(3)]
    [InlineData(5)]
    ...
    [Fact(DisplayName = "Redirect-H2-006: Infinite redirect loop returns final redirect response")]
    ...
    [Fact(DisplayName = "Redirect-H2-007: Relative Location header resolved to /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-008: Cross-scheme HTTPS to HTTP downgrade blocked by default")]
    ...
    [Fact(DisplayName = "Redirect-H2-009: POST 307 preserves method and body to /echo")]
    ...
    [Fact(DisplayName = "Redirect-H2-010: POST 303 rewrites to GET at /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-011: POST 302 rewrites to GET at /hello")]
    ...
    [Fact(DisplayName = "Redirect-H2-012: POST 308 preserves method and body to /echo")]
    ...
    [Fact(DisplayName = "Redirect-H2-013: Cross-origin redirect follows to /headers/echo")]
    ...
    [Fact(DisplayName = "Redirect-H2-014: Cross-origin redirect strips Authorization header")]
