...
public sealed class CompressionH2IntegrationTests
{
    private readonly KestrelH2Fixture _fixture;

    public CompressionH2IntegrationTests(KestrelH2Fixture fixture)
    {
        _fixture = fixture;
    }
    ...
    [Fact(DisplayName = "Compression-H2-002: deflate response transparently decompressed")]
    ...
    [Fact(DisplayName = "Compression-H2-003: brotli response transparently decompressed")]
    ...
    [Fact(DisplayName = "Compression-H2-004: identity encoding passes through unchanged")]
    ...
    [Fact(DisplayName = "Compression-H2-005: content negotiation with Accept-Encoding gzip returns gzip response")]
    ...
    [Fact(DisplayName = "Compression-H2-006: content negotiation with Accept-Encoding br returns brotli response")]
    ...
    [Fact(DisplayName = "Compression-H2-007: content negotiation with no Accept-Encoding returns identity")]
