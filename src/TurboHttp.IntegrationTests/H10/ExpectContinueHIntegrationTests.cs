...
[Collection("H10")]
public sealed class ExpectContinueHIntegrationTests
{
    private readonly ServerFixture _server;
    private readonly ActorSystemFixture _systemFixture;

    public ExpectContinueHIntegrationTests(ServerFixture server, ActorSystemFixture systemFixture)
    {
        _server = server;
    ...
    [Fact(Timeout = 30000, DisplayName = "Expect-H10-001: Small body sent without Expect header returns 200 echo over HTTP/1.0")]
    ...
    [Fact(Timeout = 30000, DisplayName = "Expect-H10-002: Large body sent without 100-continue returns 200 echo over HTTP/1.0")]
    ...
    [Fact(Timeout = 30000, DisplayName = "Expect-H10-003: Server rejection returns 417 over HTTP/1.0")]
