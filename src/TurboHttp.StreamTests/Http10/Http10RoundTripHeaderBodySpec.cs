...
/// </remarks>
public sealed class Http10RoundTripHeaderBodySpec : StreamTestBase
{
    ...
    [Fact(Timeout = 10_000)]
    [Trait("RFC", "RFC1945-7")]
    public async Task Http10RoundTripHeaderBody_should_encode_content_length_zero_when_empty_body()
    {
    ...
    [Fact(Timeout = 30_000)]
    [Trait("RFC", "RFC1945-7")]
    public async Task Http10RoundTripHeaderBody_should_serialize_and_deserialize_correctly_when_large_body_64kb()
    {
    ...
    [Fact(Timeout = 10_000)]
    [Trait("RFC", "RFC1945-7")]
    public async Task Http10RoundTripHeaderBody_should_preserve_bytes_exactly_when_binary_body()
    {
    ...
    public async Task Http10RoundTripHeaderBody_should_include_custom_headers_in_wire_when_custom_headers_set()
    {
    ...
    public async Task Http10RoundTripHeaderBody_should_parse_all_headers_when_response_has_multiple_headers()
    {
        var response = await DecodeAsync(
            "HTTP/1.0 200 OK\r\n" +
