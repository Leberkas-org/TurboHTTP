...
/// </remarks>
public sealed class StageCompletionRegressionTests : StreamTestBase
{
    [Fact(Timeout = 5000,
        DisplayName = "SCREG-001: TracingBidiStage outlet terminates on upstream failure")]
    public async Task TracingBidiStage_Outlet_Terminates_On_Upstream_Failure()
    {
