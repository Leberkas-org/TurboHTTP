...
public sealed class Http2ConnectionFlowControlSpec : StreamTestBase
{
    ...
    {
        // Default window = 65535 → threshold = max(16384, 65535/4) = 16384.
    ...
    {
        // Default threshold = 16384. Exactly 16384 bytes on a single DATA frame crosses both
        // the connection and stream thresholds simultaneously.
        ...
        Assert.Contains(windowUpdates, f => f.StreamId == 0 && f.Increment == 16384);
        Assert.Contains(windowUpdates, f => f.StreamId == 3 && f.Increment == 16384);
    }
