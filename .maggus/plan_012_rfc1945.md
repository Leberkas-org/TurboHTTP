...
- **plan_011 TASK-022**: HTTP/1.0 decompression pipeline verification (RFC 1945 §10.3)
- **plan_011 TASK-001-004**: Userinfo stripping affects Http10Encoder (RFC 9110 §4.2.4)
