...
| Field | Value |
|-------|-------|
| **Status** | ✅ Completed (superseded by [[Features/Feature020_ContentEncoding_Consolidation\|Feature 020]]) |
...
> **Note**: This stage was later renamed to `DecompressionBidiStage` and ultimately replaced by `ContentEncodingBidiStage` in [[Features/Feature020_ContentEncoding_Consolidation\|Feature 020]], which consolidated all content-encoding logic into a single BidiFlow stage.
...
- [[Features/Feature020_ContentEncoding_Consolidation\|Feature 020]] — supersedes this stage
- [[Architecture/15-STREAMS_LAYER\|Streams Layer]] — stage categories and composition
