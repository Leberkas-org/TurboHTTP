...
| **Scope** | 2 tasks (TASK-014-001 through TASK-014-002) |
...
- **TASK-014-001**: HTTP/1.0 decoder fuzzing — malformed status lines, missing headers, truncated bodies, invalid content-length values, non-UTF8 header values
- **TASK-014-002**: HTTP/1.1 decoder fuzzing — invalid chunk encoding, invalid transfer-encoding combinations, header field limit violations, pipeline request boundary errors
...
- [[Features/Feature015_H2_HPACK_Fuzzing\|Feature 015]] — companion HTTP/2 and HPACK fuzzing
- [[Architecture/16-PROTOCOL_LAYER\|Protocol Layer]] — decoder pipeline architecture
- [[Architecture/06-DECODER_PIPELINE_ARCHITECTURE\|Decoder Pipeline Architecture]] — three-layer decoder design
