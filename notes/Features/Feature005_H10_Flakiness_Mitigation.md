...
| **Scope** | 9 tasks across 3 phases |
| **Maggus Plan** | `.maggus/features/feature_005.md` |

## Description

After the [[Features/Feature004_HTTP10_Deadlock_Fix\|Feature 004 deadlock fix]], the H10 integration suite still showed 6–9 timeout failures per 88-test run (~10% failure rate). These were **not deadlocks** but resource contention timeouts caused by:
...
**Phase 1 status**: TASK-005-001 (timeout increase) and TASK-005-002 (explicit cleanup) completed.
...
- [[Features/Feature004_HTTP10_Deadlock_Fix\|Feature 004]] — prerequisite deadlock fix
- [[Architecture/12-TEST_ORGANIZATION\|Test Organization]] — collection structure and fixture patterns
