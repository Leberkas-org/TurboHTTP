...
- [[Architecture/Layers/14-TRANSPORT_LAYER\|Transport Layer]] — connection pool and keep-alive design
- [[Architecture/Layers/15-STREAMS_LAYER\|Streams Layer]] — `ConnectionReuseStage` role in pipeline
